...
public class Operacije {
    ...
    public static final int UCITAJ_LISTU_KNJIGA = 2;
    public static final int UCITAJ_LISTU_PRIMERAKA = 3;
    ...
    public static final int ZAPAMTI_PRIMERAK = 11;
    public static final int KREIRAJ_NOVU_KNJIGU = 12;
    public static final int ZAPAMTI_KNJIGU = 13;
    public static final int NADJI_KNJIGU = 14;
    public static final int NADJI_CLANOVE = 15;
    ...
    public static final int IZLOGUJ = 1001;
